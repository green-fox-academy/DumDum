...
namespace DumDum.Services
{
    public class TimeService : IHostedService
    {
        ...
        public long GetProductionCycle(int id)        //vratí cyklus na produkci za 10min 
        {                                      //nebrat, jen v tom případě, že spadne server a bude potřeba dopočítat ztracenej čas
